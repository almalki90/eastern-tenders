...
### 📡 خدمات RSS والإشعارات
- 🔔 **RSS 2.0 Feed** - للاشتراك في التحديثات
- 🔔 **Atom Feed** - خيار بديل للـ RSS
- 🤖 **بوت تليجرام متكامل** - إرسال تلقائي للمناقصات والترسيات كل 12 ساعة
  - ✅ **المجموعة**: [المقاولين ومقدمي الخدمات](https://t.me/+q3PeGsnBmoQ2ZWU0)
  - ✅ **منع التكرار** - يرسل فقط المناقصات الجديدة
...
### JSON Structure (ترسية)
```json
{
  "id": "unique-id",
  "type": "award",
  "title": "عنوان الترسية",
  "description": "وصف الترسية",
  "location": "الموقع",
  "region": "المنطقة",
  "winner": "الشركة الفائزة",
  "amount": 5000000,
...
## 🤖 بوت تليجرام المتكامل

### ✨ **الميزات**
- ✅ **إرسال تلقائي** كل 12 ساعة (12 AM & 12 PM)
- ✅ **منع التكرار** - يرسل فقط المناقصات والترسيات الجديدة
- ✅ **تنسيق احترافي** - رسائل HTML منسقة بالكامل
- ✅ **دعم الترسيات** - مع قيمة العقد والشركة الفائزة
- ✅ **إرسال للمجموعات** - دعم كامل للمجموعات

### 📱 **المجموعة المستهدفة**
**[المقاولين ومقدمي الخدمات](https://t.me/+q3PeGsnBmoQ2ZWU0)**
- Chat ID: `-1003725198996`
- تستقبل تلقائياً جميع المناقصات والترسيات الجديدة

### 🔧 **الإعداد**
راجع الدليل الكامل: [TELEGRAM-SETUP.md](TELEGRAM-SETUP.md)

1. أضف Bot Token في GitHub Secrets
2. أضف Chat ID في GitHub Secrets
3. شغّل GitHub Actions يدوياً للاختبار
4. استمتع بالتحديثات التلقائية! 🎉
